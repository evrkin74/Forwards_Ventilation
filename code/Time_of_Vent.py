...
# df = df[ ((df['year_o']==1983) &(df['month_o']<6)) | (df['year_o']==1982) ]
...
# plt.savefig('/home/users/zhenya/Forwards_Ventilation/fig/Time_of_Vent/early_vent.png',dpi=300)
...
# df['age_bool'] = df['age_bool'].mask(df['year_o'] < 1984, -1)
...
# ax.coastlines()
# cbar=fig.colorbar(cax)
# cbar.set_label(r"volume ventilated * age_bool($m^3$)")
# plt.savefig('/home/users/zhenya/Forwards_Ventilation/fig/Time_of_Vent/SEEDage_bool_vent.png',dpi=600)
